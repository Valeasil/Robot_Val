...
***Test Cases***
###SUCESSO
Exemplo 01: Teste lidando com Suite e Test Teardown
  Essa keyword o teste passara, não executando as keywords abaixo!
  Essa keyword passara sozinha!
  Essa keyword o teste falhara, não executando as keywords abaixo!

Exemplo 02: Teste lidando com Suite e Test Teardown
  Essa keyword passara sozinha!
  Essa keyword passara sozinha!
  Essa vai passar com a condição parar de executar as keywords abaixo!
  Essa keyword passara sozinha!
  Essa keyword passara sozinha!
